    ...
    <main>
        <div class="contain">
            <div class="full-content">
                <div class="items">
                    <h2 class="container"> -->content gons here  </h2>
                </div>
            </div>
            <div class="full-shop">
                <div class="items-shop container">
                    <div class="item">
        ...
        <div class="current-series container">
            <h3 class="col-3 text-white">current series</h3>
        </div>
        <div class="comics ">
            <div class="container d-flex flex-wrap pt-5 pb-3">
                <comics  :title="comic.series" :img="comic.thumb" v-for="(comic, index) in listComics" :key="index"/>
            </div> 
        </div>
    </main>
</template>
